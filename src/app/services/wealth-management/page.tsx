...
const svc = profileServices.find((s) => s.key === "wealth-management")!;
      ...
      <section className="bg-white">
        <Container className="py-12 sm:py-16">
          <Reveal>
            <SectionHeading
              eyebrow="Core focus"
              title="Preservation and long-term growth"
              subtitle="Personalized portfolio construction supported by disciplined allocation and risk profiling."
            />
          </Reveal>
            ...
            <div className="lg:col-span-5">
              <Reveal delayMs={120}>
                <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-7">
                  <div className="text-sm font-semibold text-slate-900">Designed for</div>
                  <div className="mt-4 grid gap-3">
                    {[
                      "Risk-aware allocation aligned to objectives",
                      "Preservation and disciplined growth",
                      "A long-term, governance-first mindset",
