...
const svc = profileServices.find((s) => s.key === "funding-facilitation")!;

export default function FundingFacilitationPage() {
  return (
      ...
      <section className="bg-white">
        <Container className="py-12 sm:py-16">
          <Reveal>
            <SectionHeading
              eyebrow="Core focus"
              title="Readiness, structuring, and introductions"
              subtitle="Supporting SMEs and corporates from investment readiness through to execution."
            />
          </Reveal>
            ...
            <div className="lg:col-span-5">
              <Reveal delayMs={120}>
                <div className="rounded-3xl border border-slate-200 bg-gradient-to-br from-blue-50 via-white to-indigo-50 p-7">
                  <div className="text-sm font-semibold text-slate-900">Common use cases</div>
                  <div className="mt-4 grid gap-3">
                    {[
                      "Growth capital raise for SMEs",
                      "Corporate restructuring capital",
                      "Debt, equity, and hybrid structuring",
                      "Investor introductions and execution support",
                    ].map((o) => (
