...
import { Linkedin, MapPin, Plus } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
      ...
      {subtitle ? (
        <p
          className={[
            ...
            dark ? "text-white/70" : "text-[#0b1020]/70",
          ].join(" ")}
        >
          {subtitle}
        </p>
  ...
  return (
    <>
      ...
      <section className="bg-black py-20 sm:py-24">
        <Container>
          <Reveal>
            <SectionHeader title={<>Professional Details</>} dark />
          </Reveal>
          ...
          <Reveal>
            <div className="mx-auto max-w-4xl rounded-[2rem] bg-white/5 p-10 text-center backdrop-blur-md">
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row sm:justify-center">
                <Link
                  href="/contact"
                  className="inline-flex h-12 items-center justify-center bg-white px-6 font-sans text-sm font-semibold text-[#2f6bff]"
                >
                  Contact Us
                </Link>
                <Link
                  href="/about#services"
                  className="inline-flex h-12 items-center justify-center bg-[#2f6bff] px-6 font-sans text-sm font-semibold text-white"
                >
                  View Services
                </Link>
              </div>
