...
function AvatarPlaceholder({
  ...
  if (src) {
    return (
      <div className="relative h-28 w-28 overflow-hidden rounded-full bg-white/5 ring-1 ring-white/10 sm:h-32 sm:w-32">
        <Image
          src={src}
          alt={name}
          fill
  ...
  return (
    <div className="flex h-28 w-28 items-center justify-center rounded-full bg-white/5 ring-1 ring-white/10 sm:h-32 sm:w-32">
      <UserRound className="h-10 w-10 text-white/35 sm:h-12 sm:w-12" />
    </div>
  );
}
